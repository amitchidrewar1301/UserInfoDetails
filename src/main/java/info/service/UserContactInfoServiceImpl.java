...
public class UserContactInfoServiceImpl implements UserContactInfoService {
    ...
    public ResponseEntity getAllUserContactInfo() {
        List<UserContactInfo> getAllUsers = (List<UserContactInfo>) userContactDetailsRepository.findAll();
    ...
    public ResponseEntity getUserContactInfoByIds(String ids) {
        ...
        List<UserContactInfo>  listOfUserDetails = (List<UserContactInfo>) userContactDetailsRepository.findAllById(listIds);
